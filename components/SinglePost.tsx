...
const SinglePost = (props: Props) => {
  ...
  return (
    <section className="sm:h-60 flex p-10 m-3 rounded-lg shadow-[0_5px_10px_2px_rgba(0,0,0,0.08)] border-1 dark:text-white/90  dark:shadow-[0_5px_10px_2px_#1c1c1c] dark:hover:shadow-zinc-950 ">
